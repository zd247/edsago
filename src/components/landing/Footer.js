  ...
  return (
    <footer className={styles['site-footer']}>
      <div className={styles['container']}>
        <div className={classNames(styles['site-footer-inner'], styles['has-top-divider'])}>
          <div className={classNames(styles['brand'], styles['footer-brand'])}>
            <a href='#'>
          ...
          <ul className={classNames(styles['footer-links'], styles['list-reset'])}>
            <li>
              <a href='#'>Contact</a>
            </li>
            <li>
          ...
          <ul className={classNames(styles['footer-social-links'], styles['list-reset'])}>
            <li>
              <a href='#'>
                <span className={styles['screen-reader-text']}>Facebook</span>
            ...
            <li>
              <a href='#'>
                <span className={styles['screen-reader-text']}>Google</span>
                <svg width='16' height='16' xmlns='http://www.w3.org/2000/svg'>
                  <path
          ...
          <div className={styles['footer-copyright']}>&copy; 2018 April, all rights reserved</div>
        </div>
      </div>
    </footer>
  )
