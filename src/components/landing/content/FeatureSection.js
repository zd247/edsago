  ...
  return (
    <section className={classnames(styles['features'], styles['section'])}>
      <div className={styles['container']}>
        <div className={classnames(styles['features-inner'], styles['section-inner'])}>
          <div className={classnames(styles['features-header'], styles['text-center'])}>
            <div className={styles['container-sm']}>
              <h2 className={classnames(styles['section-title'], styles['mt-0'])}>Meet April</h2>
          ...
          <div className={styles['features-wrap']}>
            <div className={classnames(styles['feature'], styles['text-center'], styles['is-revealing'])}>
              <div className={styles['feature-inner']}>
                <div className={styles['feature-icon']} styles='background:#FFD2DA;'>
                ...
                <h4 className={classnames(styles['feature-title'], styles['h3-mobile'], styles['mb-8'])}>Powerful</h4>
            ...
            <div className={classnames(styles['feature'], styles['text-center'], styles['is-revealing'])}>
              <div className={styles['feature-inner']}>
                <div className={styles['feature-icon']} styles='background:#FFD8CD;'>
                  <svg width='88' height='88' xmlns='http://www.w3.org/2000/svg'>
                    <g fill='none' fillRule='nonzero'>
                      <path
            ...
            <div className={classnames(styles['feature'], styles['text-center'], styles['is-revealing'])}>
              <div className={styles['feature-inner']}>
                <div className={styles['feature-icon']} styles='background:#C6FDF3;'>
                  <svg width='88' height='88' xmlns='http://www.w3.org/2000/svg'>
                    <g fill='none' fillRule='nonzero'>
            ...
            <div className={classnames(styles['feature'], styles['text-center'], styles['is-revealing'])}>
              <div className={styles['feature-inner']}>
                <div className={styles['feature-icon']} styles='background:#E0E1FE;'>
                  <svg width='88' height='88' xmlns='http://www.w3.org/2000/svg'>
                    <g fill='none' fillRule='nonzero'>
                      <path
